...
<table class="programme-table py-4" id="pnm20-day1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>UNMAPPED PH</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Potentials for open-source land use change simulation in local planning</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>How Open Mapping Can Make A Big Impact to the Sustainable Development Goals</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Common Alerting Protocol In the Philippines</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>The State of MapRoulette</strong></a>
...
<table class="programme-table py-4" id="pnm20-day2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>How the COVID-19 Pandemic Remapped the Reality:<br>HOT Philippines’ Field Mapping Team Narratives</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>An Open-Source DInSAR Software For Monitoring Ground Deformation<br>Using Radar Satellites</strong></a>
    ...
    <tbody>
        <tr>
            ...
            <td id="session_#">
                ...
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Kaart: Improving OpenStreetMap Together</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Mapping the Geography of the UAAP Men's Basketball Tournament (Season 81)</strong></a>
                <p class="small speaker">Ben Hur Pintor</p>
            </td>
        </tr>
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Ten QGIS Plugins in 10 minutes</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                ...
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Some lesser-known functions of QGIS</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>OSM Data Coverage Evaluation</strong></a>
        ...
        <tr>
            ...
            <td id="session_#">
                <a href="{{ site.baseurl }}/programme/session/#"><strong>Closing</strong></a>
                <p class="small speaker">Pista ng Mapa Organizers</p>
            </td>
        </tr>  
    </tbody>
